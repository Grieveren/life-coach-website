...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section 
      ...
      className="min-h-screen min-h-screen-small flex items-center justify-center bg-gradient-to-br from-secondary-50 via-primary-50 to-secondary-100 px-4 sm:px-6 lg:px-8 py-16 sm:py-20"
    >
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
          {/* Content Column */}
          <div className="text-center lg:text-left order-2 lg:order-1 space-y-4 sm:space-y-6">
            <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Hi, I'm{' '}
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="w-64 h-64 xs:w-72 xs:h-72 sm:w-80 sm:h-80 lg:w-[28rem] lg:h-[28rem] rounded-full bg-gradient-to-br from-primary-200 to-secondary-200 flex items-center justify-center shadow-2xl transition-all duration-500 hover:shadow-3xl hover:scale-105">
              ...
              <div className="hidden xs:block absolute -top-4 -right-4 w-6 h-6 sm:w-8 sm:h-8 bg-primary-400 rounded-full opacity-70 animate-pulse"></div>
              <div className="hidden xs:block absolute -bottom-6 -left-6 w-8 h-8 sm:w-12 sm:h-12 bg-secondary-400 rounded-full opacity-50 animate-pulse delay-1000"></div>
              <div className="hidden sm:block absolute top-1/4 -left-8 w-6 h-6 bg-primary-300 rounded-full opacity-60 animate-pulse delay-500"></div>
            </div>
          </div>
        </div>
      </div>
